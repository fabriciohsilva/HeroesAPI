...
class MongoDB extends ICrud {
    ...
    async isConnected() {
     ...
     // 1o 
    static connect() {
        Mongoose.connect('mongodb+srv://admin:Final4265@heroes-p2xmt.mongodb.net/test?retryWrites=true', {
    ...
    async read(item = {}) {
        return this._collection.find(item, { nome: 1, poder: 1, fraqueza: 1, vilao: 1, avatar: 1, insertedAt: 1})
    }
